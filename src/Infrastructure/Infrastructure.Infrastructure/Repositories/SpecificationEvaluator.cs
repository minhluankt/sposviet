...
using Infrastructure.Infrastructure.Evaluator;
...
using SearchEvaluator = Infrastructure.Infrastructure.Evaluator.SearchEvaluator;

namespace Infrastructure.Infrastructure.Repositories
{
   // public class SpecificationEvaluator<T> where T
