...
namespace Web.ManagerApplication.Areas.Admin.Controllers
{
    ...
    public class FileSystemController : Controller
    {
        ...
        {
            // Thư mục gốc lưu trữ là wwwwroot/files-efinder (đảm bảo có tạo thư mục này)
            string pathroot = "files-efinder";
            ...
            var root = new RootVolume(rootDirectory, url, urlthumb)
            {
                ...
                Alias = "files-efinder", // Beautiful name given to the root/home folder
