...
namespace Application.Hepers
{
    public class EncryptionHelper
    {
        ...
        private const string Key = SystemVariableHelper.publicKey;
        ...
        public static string EncryptPass(string str, string publicKeypass)
        {
            string EncrptKey = publicKeypass;
            byte[] byKey = { };
        ...
        public static string DecryptPass(string str, string publicKeypass)
        {
            str = str.Replace(" ", "+");
            string DecryptKey = publicKeypass;
            byte[] byKey = { };
            byte[] IV = { 18, 52, 86, 120, 144, 171, 205, 239 };
