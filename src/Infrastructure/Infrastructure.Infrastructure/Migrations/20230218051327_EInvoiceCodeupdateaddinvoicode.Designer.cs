...
namespace Infrastructure.Infrastructure.Migrations
{
    ...
    [Migration("20230218051327_EInvoiceCodeupdateaddinvoicode")]
    partial class EInvoiceCodeupdateaddinvoicode
    {
            ...
            modelBuilder.Entity("Domain.Entities.EInvoice", b =>
                {
                    ...
                    b.HasIndex("Fkey", "InvoiceCode", "MCQT")
                        .IsUnique()
                        .HasFilter("[InvoiceCode] IS NOT NULL AND [MCQT] IS NOT NULL");

                    b.HasIndex("IdInvoice", "CusCode", "ComId");
