...
namespace Application.Interfaces.Repositories
{
    public interface IOrderTableRepository
    {
        ...
        Task<Result<PublishInvoiceResponse>> CheckOutOrderStaffAsync(int comid, int Idpayment, Guid idOrder, decimal discountPayment, decimal Amount,decimal Total, string Cashername, string IdCasher, EnumTypeProduct enumType = EnumTypeProduct.AMTHUC);
        Task<Result<PublishInvoiceResponse>> CheckOutOrderAsync(int comid, int Idpayment, Guid idOrder, decimal discountPayment,  decimal discount, decimal? discountOther, decimal? AmountCusPayment,decimal Total, decimal Amount,decimal VATAmount, string Cashername, string IdCasher, bool vat, int? Vatrate, int? ManagerPatternEInvoices, EnumTypeProduct enumType = EnumTypeProduct.AMTHUC);
