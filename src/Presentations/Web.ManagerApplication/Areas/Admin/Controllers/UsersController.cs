...
namespace Web.ManagerApplication.Areas.Admin.Controllers
{
    ...
    public class UsersController : BaseController<UsersController>
    {
        ...
        public IActionResult getSelect2(string idselectd)
        {
            ...
            var allUsersExceptCurrentUser = from d in _userManager.Users where d.ComId == currentUser.ComId select new { id = d.Id, text = !string.IsNullOrEmpty(d.FullName) ? d.FullName : d.FirstName + " " + d.LastName, selected = d.Id == idselectd };
